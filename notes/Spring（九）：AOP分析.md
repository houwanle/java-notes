...
然后看看Pointcut的设计，也就是切入点的处理。

![Spring（九）：AOP分析_11.png](./pics/Spring（九）：AOP分析_11.png)

Pointcut的两种实现方式

![Spring（九）：AOP分析_12.png](./pics/Spring（九）：AOP分析_12.png)
...
![Spring（九）：AOP分析_13.png](./pics/Spring（九）：AOP分析_13.png)
...
![Spring（九）：AOP分析_14.png](./pics/Spring（九）：AOP分析_14.png)

![Spring（九）：AOP分析_15.png](./pics/Spring（九）：AOP分析_15.png)

![Spring（九）：AOP分析_16.png](./pics/Spring（九）：AOP分析_16.png)

在registerOrEscalateApcAsRequired方法中会把上面的Java类注入到容器中。

![Spring（九）：AOP分析_17.png](./pics/Spring（九）：AOP分析_17.png)
...
![Spring（九）：AOP分析_18.png](./pics/Spring（九）：AOP分析_18.png)

那么具体处理的逻辑

![Spring（九）：AOP分析_19.png](./pics/Spring（九）：AOP分析_19.png)

#### 如何串联

Bean的IoC是如何和对应的BeanPostProcessor串联的呢？我们来看看。

![Spring（九）：AOP分析_20.png](./pics/Spring（九）：AOP分析_20.png)

![Spring（九）：AOP分析_21.png](./pics/Spring（九）：AOP分析_21.png)

![Spring（九）：AOP分析_22.png](./pics/Spring（九）：AOP分析_22.png)

![Spring（九）：AOP分析_23.png](./pics/Spring（九）：AOP分析_23.png)

![Spring（九）：AOP分析_24.png](./pics/Spring（九）：AOP分析_24.png)

isInfrastructureClass方法判断是否是基础设施

![Spring（九）：AOP分析_25.png](./pics/Spring（九）：AOP分析_25.png)

shouldSkip：是否应该跳过，会完成相关的advisor的收集

![Spring（九）：AOP分析_26.png](./pics/Spring（九）：AOP分析_26.png)
...
![Spring（九）：AOP分析_27.png](./pics/Spring（九）：AOP分析_27.png)
...
![Spring（九）：AOP分析_28.png](./pics/Spring（九）：AOP分析_28.png)
...
![Spring（九）：AOP分析_29.png](./pics/Spring（九）：AOP分析_29.png)

然后我们来看看 ProxyFactory的体系结构

![Spring（九）：AOP分析_30.png](./pics/Spring（九）：AOP分析_30.png)
...
![Spring（九）：AOP分析_31.png](./pics/Spring（九）：AOP分析_31.png)
...
![Spring（九）：AOP分析_32.png](./pics/Spring（九）：AOP分析_32.png)
...
![Spring（九）：AOP分析_33.png](./pics/Spring（九）：AOP分析_33.png)
...
![Spring（九）：AOP分析_34.png](./pics/Spring（九）：AOP分析_34.png)

代理方法

![Spring（九）：AOP分析_35.png](./pics/Spring（九）：AOP分析_35.png)
