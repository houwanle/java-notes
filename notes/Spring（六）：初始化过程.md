...
要搞清楚上面的代码含义首先需要搞清楚这两者之间的关系。

![Spring（六）：初始化过程_1.png](./pics/Spring（六）：初始化过程_1.png)

实现的核心流程就是

![Spring（六）：初始化过程_2.png](./pics/Spring（六）：初始化过程_2.png)
...
> finishBeanFactoryInitialization 初始化剩下的单实例（非懒加载的）。
